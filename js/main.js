...
const RELEASES = [
  {
    ...
    latest: true,
    notes: [
      "New UGC ad sets for Shoes, Apparel (tops/dresses/shorts) & Gadgets — all built from one product photo",
      "Smarter review montages: adapts to each product type, closes on a scene + product showcase shot",
    ],
  },
  {
    version: "3.3.1",
